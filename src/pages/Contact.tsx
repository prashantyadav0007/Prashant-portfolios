...
const Contact: React.FC = () => {
  ...
  return (
    <PageTransition>
      <SEO
        title="Contact Prashant Yadav (Prashant Yadav) - Hire Freelance Full Stack Developer"
        description="Get in touch with Prashant Yadav (Rolan RNR) for web development, security tools, or custom software projects."
        keywords="Contact Prashant Yadav, Prashant Yadav, Hire Developer, Freelance Web Developer"
